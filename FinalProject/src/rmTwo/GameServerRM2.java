...
public class GameServerRM2 {
	...
	public GameServerRM2(String serverName) {
		this.GL = rmTwo.GL.valueOf(serverName);
...
//		System.out.println("1. Account Info " + accountinfo);
		...
		Object result;
            	byte[] message = UDPClient(rmTwo.GL.valueOf(newserverName), accountinfo.trim(), "createAccount");
            	result =   Utils.byteArrayToObject(message);
