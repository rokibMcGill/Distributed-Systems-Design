...
public class RM2 {
	...
	public static PriorityQueue<Message> fiform2 = new PriorityQueue<Message>(new MessageComparator());
	...
	private static void receive() {
			...
			try
			{
				...
				System.out.println("Server Started in RM2............");
				while (true) {
...
//					System.out.println("  ");
//					System.out.println("RM2 received request.....: " + message);
	...
	private static void sendMessageToReplica() {
		System.out.println("  ");
		System.out.println("RM2: Size of FIFO :   " + fiform2.size());
		Iterator<Message> itr = fiform2.iterator(); 
...
//		}	
	...
	private static void faultHandler(String message) {
		...
		if(ms[2].equals("200") || ms[2].equals("201") || ms[2].equals("202")) {
