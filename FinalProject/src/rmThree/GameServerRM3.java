...
import rmThree.Utils;

public class GameServerRM3 {
	final Logger LOGGER = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);
	String serverName;
	private GL GL;
	
	private HashMap<String, ArrayList<ArrayList<String>>> glDatabase = new  HashMap<>();
	public GameServerRM3(String serverName) {
		this.GL = rmThree.GL.valueOf(serverName);
...
//		ArrayList<String> value =  getAccountInfo(username);		
		...
		for(ArrayList<ArrayList<String>> dblist : collection) {
//			System.out.println("User info"+ dblist);
			for(List<String> db : dblist) {
...
//	private boolean isIPNameExist(String ip) {
//		Collection<ArrayList<ArrayList<String>>> collection = glDatabase.values();
//		if (collection.isEmpty()) return false;
//		for(ArrayList<ArrayList<String>> dblist : collection) {
//			for(List<String> db : dblist) {
//				if(String.valueOf(ip).equals(db.get(5))) return true;
//			}
//		}
//		return false;
//	}
//
//	private boolean isPasswordNameExist(String password) {
//		Collection<ArrayList<ArrayList<String>>> collection = glDatabase.values();
//		if (collection.isEmpty()) return false;
//		for(ArrayList<ArrayList<String>> dblist : collection) {
//			for(List<String> db : dblist) {
//				if(password.equals(db.get(4))) return true;
//			}
//		}
//		return false;
//	}
	...
	public void display() {
//		LOGGER.info("Data Base Updated" + " Server[ " + this.GL +" ]");
	}
...
//		System.out.println("Account Suspendded Name: " + suspendAccount);
...
//			System.out.println("Clone Suspendded Name: " + value);
		} 	
		}
...
//		System.out.println("1. Account Info " + accountinfo);
		int newipint = Utils.getIntegerIpaddress(newIp);
		String newserverName = Utils.decideServerPort(newipint);			
		Object result;
            	byte[] message = UDPClient(rmThree.GL.valueOf(newserverName), accountinfo.trim(), "createAccount");
            	result =   Utils.byteArrayToObject(message);
